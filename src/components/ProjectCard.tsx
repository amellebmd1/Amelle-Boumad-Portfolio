  ...
  return (
    <>
      ...
      {expanded && (
        ...
        >
          <div
            className={`mini-window w-full max-h-[95vh] overflow-y-auto animate-zoom-reveal ${youtubeId || macPreviewImage || phonePreviewImage || fullMockupImage ? 'mx-4 max-w-5xl' : 'mx-4 max-w-3xl'}`}
