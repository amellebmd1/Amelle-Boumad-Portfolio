  ...
  return (
    <>
      ...
      {expanded && (
        ...
        >
          <div
            className={`mini-window w-full mx-4 max-h-[95vh] overflow-y-auto animate-zoom-reveal ${youtubeId ? 'max-w-7xl' : macPreviewImage || phonePreviewImage || fullMockupImage ? 'max-w-5xl' : 'max-w-3xl'}`}
